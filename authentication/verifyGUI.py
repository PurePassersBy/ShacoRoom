...
class Ui_Verify(object):
    ...
    def retranslateUi(self, Verify):
        ...
        self.nameStatus.setText(_translate("Verify", " "))
        self.passwordStatus.setText(_translate("Verify", " "))
        self.codeStatus.setText(_translate("Verify", " "))
        self.mailStatus.setText(_translate("Verify", " "))
